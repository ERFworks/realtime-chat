...
from app.api.deps import get_current_user, get_uow, get_token_store, oauth2_scheme
...
async def login(
    ...
    return await auth_service.authenticate_user(uow, token_store, form_data.username, form_data.password)
...
async def logout(
    ...
    await auth_service.logout(token_store, current_user.user_id, token, payload_in.refresh_token)
